            ...
            if (e.getSource() == btnAgregar) {
                if (btnAgregar.getText().equals("Nuevo")) {
                    ...
                    if (!verificarCampos()) {
                        ...
                        direccion.setBarrio(txtBarrio.getText());
                        ...
                        telefono1.setNumero(Long.parseLong(txtTelefono1.getText()));
                        telefono1.setTipo((String) cBoxTelefono1.getSelectedItem());
                        listaTelefonos.add(telefono1);

                        if (!"".equals(txtTelefono2.getText())) {
                            Telefono telefono2 = new Telefono();
                            long aux_ = Long.parseLong(txtTelefono2.getText());
                            telefono2.setNumero(aux_);                           
                            telefono2.setTipo((String) cBoxTelefono2.getSelectedItem());
                            listaTelefonos.add(telefono2);
                        } else if (!"".equals(txtTelefono3.getText())) {
                            Telefono telefono3 = new Telefono();
                            telefono3.setNumero(Long.parseLong(txtTelefono3.getText()));
                            telefono3.setTipo((String) cBoxTelefono3.getSelectedItem());
                            listaTelefonos.add(telefono3);

                        }

                        Persona persona = new Persona();
                        persona.setNombre(lblNombres.getText());
                        persona.setApellidos(lblApellidos.getText());
                        persona.setFecha(lblFechaNacimiento.getText());
                        long aux = Long.parseLong(txtId.getText());
                        persona.setId(aux);
                        persona.setIdTipo((String) cBoxTipoId.getSelectedItem());
                        ArrayList<Direccion> listaDirecciones = new ArrayList<>();
                        listaDirecciones.add(direccion);
                        persona.setDirreciones(listaDirecciones);
                        
                        for (int i = 0; i < listaDirecciones.size(); i++) {
                            System.out.println(listaDirecciones.get(i).getBarrio());
                        }
                    }
                }
            }
